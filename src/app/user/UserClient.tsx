        ...
        <div className="max-w-xl mx-auto px-5 pt-6 pb-5">
          <div className="flex items-center gap-3 mb-5">
            ...
            <div>
              ...
              <p className="text-[11px] text-white/30">Dodaj pjesme u red</p>
            </div>
          </div>
              ...
              {results.map((r) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="flex-1 text-[13px] font-medium truncate text-white/90">
                      {r.title}
                    </span>
                    {isAdded && (
        ...
        <div>
          ...
          <div className="space-y-1">
            {songs.map((song, i) => (
              <div
                key={song.id}
                className="group flex items-center gap-3.5 p-3 rounded-xl hover:bg-white/[0.05] transition-all duration-200"
              >
                <span className="w-5 text-center text-[11px] text-white/20 tabular-nums flex-shrink-0">
                  {i + 1}
                </span>
                {song.thumbnail && (
                  <img src={song.thumbnail} alt="" className="w-11 h-11 rounded-lg object-cover flex-shrink-0 shadow-md" />
                )}
                <span className="flex-1 text-[13px] font-medium truncate text-white/90">{song.title}</span>
                <button
